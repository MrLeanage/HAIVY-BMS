...
public class SalesInfoCashierController implements Initializable {
    ...
    private final String uID = UserAuthentication.getAuthenticatedSession().getuID();
    private final String uName = UserAuthentication.getAuthenticatedSession().getuName();
    @Override
